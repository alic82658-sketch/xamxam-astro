...
assert.equal(professionSlugs.size, 6, 'La version éditoriale doit conserver six parcours métiers');
for (const [slug, profession] of Object.entries(editorial.professions)) {
  assert(editorial.guides[profession.guide], `Métier ${slug} sans guide publié`);
}
